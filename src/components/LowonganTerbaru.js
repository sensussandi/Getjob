                    ...
                    <div className="space-y-2.5">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-600">
                          Tutup: <span className="font-medium text-gray-700">{job.tanggal_ditutup}</span>
                        </span>
                      </div>
                    </div>

                    {/* Apply Button */}
                    <button className="w-full mt-5 bg-[#800000] hover:bg-[#5c0000] text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all group-hover:shadow-lg">
